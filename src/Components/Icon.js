...
export const Applepay = (props) => {
  return (
    <svg viewBox="0 0 170 170" fill="gray" className="w-3 h-3">
...
export const Googlepay = (props) => {
  return (
    <svg
      ...
      height="12"
    >
      <path fill="#757575" d="M38 12v24H10V12h28m2-2H8v28h32V10z" />
    </svg>
  );
};
...
export const AButton = (props) => {
  return (
    <button className="flex gap-0 text-xs items-center bg-slate-200 px-2 rounded-lg">
      <Applepay />
      Pay
    </button>
  );
